...
public class ManagementCompanyGFATest {
	...
	public void testAddProperty() {
		...
		assertEquals(mangementCo.addProperty(sampleProperty),-3.0,-3.0);	//property has been successfully added to index 0
	}
	
	@Test
	public void testGetPropertiesCount() {
		sampleProperty = new Property ("Sunsational", "Beckman", 2613, "BillyBob Wilson",2,5,2,2);		 
		assertEquals(mangementCo.addProperty(sampleProperty),-3.0,-3.0);	
	...
	public void testToString() {
		...
		assertEquals(mangementCo.addProperty(sampleProperty), -3);	//property has been successfully added to index 0
